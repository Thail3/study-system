  ...
  <figure class="lb-figure">
    <svg viewBox="0 0 900 320" xmlns="http://www.w3.org/2000/svg" class="lb-svg">
      ...
      <g v-for="(c, i) in clients" :key="'client' + i">
        <rect x="40" :y="c.y" width="50" height="40" fill="var(--diagram-blue-wash)" stroke="var(--diagram-blue)" stroke-width="1.5" />
        <line x1="46" :y1="c.y + 8" x2="84" :y2="c.y + 8" stroke="var(--diagram-blue)" stroke-width="1" />
        <text x="65" :y="c.y + 55" text-anchor="middle" class="node-label">{{ c.label }}</text>
      </g>

      <rect x="170" y="120" width="120" height="70" fill="var(--accent-wash)" stroke="var(--accent)" stroke-width="2" />
      ...
      <g v-for="(s, i) in servers" :key="'server' + i">
        <rect x="380" :y="s.y" width="110" height="60" fill="var(--diagram-violet-wash)" stroke="var(--diagram-violet)" stroke-width="1.5" />
        <path :d="`M392,${s.y + 15} L468,${s.y + 15} M392,${s.y + 30} L468,${s.y + 30} M392,${s.y + 45} L468,${s.y + 45}`" stroke="var(--diagram-violet)" stroke-width="1" />
      ...
      <ellipse cx="690" cy="110" rx="50" ry="14" fill="var(--diagram-rose-wash)" stroke="var(--diagram-rose)" stroke-width="1.5" />
      <path d="M640,110 L640,190 A50,14 0 0 0 740,190 L740,110" fill="var(--diagram-rose-wash)" stroke="var(--diagram-rose)" stroke-width="1.5" />
      <path d="M640,150 A50,14 0 0 0 740,150" fill="none" stroke="var(--diagram-rose)" stroke-width="1" />
