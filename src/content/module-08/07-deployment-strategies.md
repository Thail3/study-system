ลองนึกภาพคนงานเหมืองสมัยก่อนที่เอา**นกคีรีบูน**ลงไปในเหมืองถ่านหินด้วย — ถ้ามีแก๊สพิษรั่วในเหมือง นกจะตายก่อนคนเพราะไวต่อแก๊สกว่ามาก คนงานเห็นนกตายก็รีบขึ้นจากเหมืองทันทีก่อนแก๊สจะกระทบทุกคน นี่คือที่มาของคำว่า **"canary deployment"** จริงๆ — ปล่อย code เวอร์ชันใหม่ไปหา user กลุ่มเล็กๆ ก่อน (เหมือนนก) ถ้ามีปัญหาจะเห็นสัญญาณเตือนก่อนที่ user ทุกคนจะโดนกระทบ
...
วิธีง่ายที่สุดคือหยุดระบบ อัปเดตทุกเครื่องพร้อมกัน แล้วเปิดใหม่ — ถ้า v2 ไม่มีบั๊กก็จบด้วยดี แต่ถ้ามีบั๊ก **user ทุกคนโดนกระทบพร้อมกันทันที** และการ rollback ก็ต้องหยุดระบบอีกรอบเพื่อกลับไป v1 — ความเสี่ยงสูงสุดเท่าที่จะเป็นไปได้
...
Canary ต่างจาก Rolling ตรงที่**จงใจปล่อยทีละเปอร์เซ็นต์เล็กๆ ก่อน แล้วหยุดดู metric** (error rate, latency) ก่อนขยายสัดส่วนเพิ่ม — ถ้า metric ผิดปกติ rollback ทันทีโดยกระทบ user แค่ไม่กี่เปอร์เซ็นต์ ไม่ใช่ทุกคน นี่คือจุดที่ **Observability กับ Deployment ทำงานคู่กัน**: ไม่มี metric ที่ดี ก็ไม่รู้ว่าจะปล่อย canary ต่อหรือควร rollback
