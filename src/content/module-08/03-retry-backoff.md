...
ถ้า retry ทันทีโดยไม่รอเลย และมี client จำนวนมากทำแบบเดียวกันพร้อมกัน (เช่น service ที่พึ่งฟื้นจาก downtime) จะเกิด<mark class="hl-warning">thundering herd — สายเรียกเข้าถล่มโอเปอเรเตอร์พร้อมกันทันทีที่ระบบโทรศัพท์กลับมาใช้ได้ ทำให้ล่มซ้ำอีกรอบ</mark>
