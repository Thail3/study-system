...
ลองกดให้ node หายไปเรื่อยๆ ในตัวอย่างข้างบนจนเหลือไม่ถึง 3 — ระบบจะ**ปฏิเสธไม่เลือก leader ใหม่เลย** แทนที่จะฝืนเลือกจากเสียงข้างน้อย นี่คือการเลือก**ยอม unavailable (หยุดรับ write ชั่วคราว) แทนที่จะเสี่ยง inconsistent (ข้อมูลขัดแย้งกันจาก split-brain)** — สอดคล้องกับ CAP theorem ที่เรียนไปแล้ว: ตอนเครือข่ายมีปัญหาจริง ระบบเหล่านี้เลือก **C (Consistency) เหนือ A (Availability)** โดยตั้งใจ
