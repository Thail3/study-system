...
ทุกระบบต้องเก็บข้อมูลถาวรที่ไหนสักที่ — สองทางเลือกหลักคือ **SQL (Structured Query Language, relational)** ซึ่งเหมือนตู้เอกสารมีระเบียบ กับ **NoSQL** ซึ่งเหมือนกล่องอเนกประสงค์ ไม่ใช่ว่าอันไหนดีกว่าเสมอ แต่เหมาะกับรูปแบบข้อมูล/การใช้งานต่างกัน
