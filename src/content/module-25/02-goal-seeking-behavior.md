...
Goal-seeking behavior คือลายเซ็นของระบบที่**คาดเดาได้และควบคุมได้** — ไม่ว่าจุดเริ่มต้นจะเลวร้ายแค่ไหน (โหลดพุ่ง, error สูง, backlog บาน) ถ้าระบบมี balancing loop ที่แข็งแรงพอและไม่มี delay มากเกินไป มันจะค่อยๆ ไต่กลับเข้าสู่สภาวะที่ยอมรับได้เองโดยไม่ต้องมีใครเข้าไปแทรกแซงซ้ำๆ
...
ความเร็วในการไล่เข้าเป้าหมาย (strength ของ loop) มีผลมาก — strength ต่ำเกินไป ระบบจะไล่เข้าเป้าหมายช้ามาก ผู้ใช้ทนสภาวะไม่ดีนานเกินจำเป็น (เช่น autoscaling ที่ scale ทีละ 1 instance ตอน traffic พุ่งแรง ทำให้ผู้ใช้เจอ latency สูงนานหลายนาทีก่อนจะกลับสู่ปกติ) แต่ strength สูงเกินไป (ปรับแรงเกินไปในแต่ละรอบ) จะทำให้กราฟไม่ไล่เข้าเป้าหมายอย่างนุ่มนวลอีกต่อไป แต่จะแกว่งเลยเป้าหมายไปมา — ซึ่งคือพฤติกรรมของหัวข้อถัดไปพอดี: **Oscillation**
