...
ข้อมูลที่วิ่งผ่าน network สาธารณะ (โดยเฉพาะ Wi-Fi สาธารณะ) ผ่านหลายจุดที่อาจถูกดักฟังได้ เหมือนจดหมายที่ผ่านมือคนหลายคนกว่าจะถึงปลายทาง TLS ปิดผนึกข้อมูลตั้งแต่ต้นทางถึงปลายทาง แม้มีคนดักจับซองได้ก็แกะอ่านเนื้อหาไม่ออก (นี่คือเหตุผลที่ทุกเว็บสมัยใหม่ต้องเป็น HTTPS ไม่ใช่ HTTP เฉยๆ)
