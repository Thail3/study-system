...
## ขั้นสูง (สั้นๆ): คุยทีละคิว vs คุยพร้อมกันหลายเรื่องในสายเดิม

HTTP/1.1 ต่อสายโทรศัพท์เดิมค้างไว้ได้ (keep-alive) แต่ยัง**คุยได้ทีละเรื่อง**ในสายนั้น — ถ้าออเดอร์แรกช้า (ร้านยังเตรียมของไม่เสร็จ) ออเดอร์ถัดไปในสายเดียวกันต้องรอคิวจริง เรียกว่า <mark class="hl-term">Head-of-Line Blocking</mark> — เหมือนโทรศัพท์สายเดียวที่คุยได้ทีละประโยค แม้อยากถามเรื่องใหม่ก็ต้องรอเรื่องเดิมจบก่อน HTTP/2 แก้ปัญหานี้ด้วย <mark class="hl-insight">multiplexing — คุยหลายเรื่องสลับกันได้ในสายเดียวกันพร้อมกัน ไม่ต้องรอเรื่องก่อนหน้าจบก่อน</mark> (แต่ TCP ชั้นล่างยังมี head-of-line blocking ของตัวเองอยู่ดี ถ้า packet หายไปหนึ่งชิ้น ทุก stream บนสายนั้นยังต้องรอ — นี่คือเหตุผลที่ HTTP/3 เปลี่ยนไปใช้ QUIC บน UDP แก้ปัญหานี้อีกชั้น)
