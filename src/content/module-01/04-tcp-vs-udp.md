...
HTTP ที่เรียนมาตลอด (บทที่แล้ว) ต้องวิ่งอยู่บน protocol ระดับล่างกว่าอีกชั้นหนึ่ง — ส่วนใหญ่ใช้ตัวที่เหมือนจดหมายลงทะเบียน เรียกว่า **TCP** แต่บางระบบ (เกม, video call, DNS ที่เพิ่งเรียนไป) เลือกใช้ตัวที่เหมือนโปสการ์ด เรียกว่า **UDP** แทน เพราะต้องการคุณสมบัติคนละแบบ
