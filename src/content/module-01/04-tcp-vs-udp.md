...
HTTP (HyperText Transfer Protocol) ที่เรียนมาตลอด (บทที่แล้ว) ต้องวิ่งอยู่บน protocol ระดับล่างกว่าอีกชั้นหนึ่ง — ส่วนใหญ่ใช้ตัวที่เหมือนจดหมายลงทะเบียน เรียกว่า **TCP (Transmission Control Protocol)** แต่บางระบบ (เกม, video call, DNS - Domain Name System - ที่เพิ่งเรียนไป) เลือกใช้ตัวที่เหมือนโปสการ์ด เรียกว่า **UDP (User Datagram Protocol)** แทน เพราะต้องการคุณสมบัติคนละแบบ
...
> คำถามสัมภาษณ์: "ทำไม DNS ใช้ UDP ทั้งที่ก็สำคัญ" — เพราะคำถาม-คำตอบสั้นมาก (แค่รอบเดียวจบ) การเช็คก่อนส่งแบบจดหมายลงทะเบียนจะช้ากว่าตัวข้อมูลจริงเสียอีก ถ้าโปสการ์ดหายไป ก็แค่ถามใหม่อีกรอบ ต้นทุนต่ำกว่าการรับประกันทุกครั้งมาก
