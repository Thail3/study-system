...
จุดร่วมของ anti-pattern ทั้งสี่แบบคือล้วนเกิดจากการยึด "หน้าตาภายนอก" ของสถาปัตยกรรมที่ต้องการ (แยก service, แยก deploy) โดยไม่ได้แก้ปัญหา coupling ที่แท้จริงข้างใน เหมือนการกั้นผนังออฟฟิศแต่ไม่ได้แยกสายไฟ — เห็นภาพว่าแยกแล้ว แต่ระบบยังทำงานเป็นก้อนเดียวกันอยู่ดี
