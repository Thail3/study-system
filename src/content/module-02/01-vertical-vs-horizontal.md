...
ในโลกซอฟต์แวร์ ทางเลือกแรกเรียกว่า **Scale Up (Vertical Scaling)** — เพิ่มกำลังให้ server เครื่องเดิม (CPU - Central Processing Unit - แรงขึ้น, RAM - Random Access Memory - เยอะขึ้น, SSD - Solid State Drive - เร็วขึ้น) ส่วนทางเลือกที่สองเรียกว่า **Scale Out (Horizontal Scaling)** — เพิ่มจำนวน server แทนที่จะทำเครื่องเดิมให้แรงขึ้น
