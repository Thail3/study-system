...
พอแตกเป็นฟู้ดคอร์ท (microservices, บทที่แล้ว) แต่ละร้านต้องคุยกันผ่าน "ทางเดินกลาง" (network) — สองมาตรฐานหลักที่ใช้กำหนด "จะคุยกันด้วยรูปแบบไหน" คือ **REST (Representational State Transfer)** (เหมือนจดหมายเต็มรูปแบบ) กับ **gRPC (gRPC Remote Procedure Call)** (เหมือนรหัสลับที่ตกลงกันไว้ก่อน)
