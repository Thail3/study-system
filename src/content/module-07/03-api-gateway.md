...
มี microservices หลายตัว (order, payment, user, inventory — เหมือนหลายร้านในห้าง) — ถ้าให้ client ภายนอกรู้จัก**ทุก service แยกกัน**ต้องยิง request ไปหลาย URL (Uniform Resource Locator), จัดการ auth เองทุกที่, ปัญหาจะยุ่งเหยิงเร็วมาก <mark class="hl-term">API Gateway</mark> คือพนักงานต้อนรับหน้าห้างของระบบซอฟต์แวร์ — ประตูเดียวที่ client คุยด้วย
