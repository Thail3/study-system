...
มี microservices หลายตัว (order, payment, user, inventory — เหมือนหลายร้านในห้าง) — ถ้าให้ client ภายนอกรู้จัก**ทุก service แยกกัน**ต้องยิง request ไปหลาย URL, จัดการ auth เองทุกที่, ปัญหาจะยุ่งเหยิงเร็วมาก **API Gateway** คือพนักงานต้อนรับหน้าห้างของระบบซอฟต์แวร์ — ประตูเดียวที่ client คุยด้วย
...
> ข้อควรระวัง: Gateway กลายเป็น**จุดเดียวที่ทุกคนต้องผ่าน**เหมือน Load Balancer เดี่ยวในบทต้น — ต้องมีพนักงานต้อนรับมากกว่า 1 คนเสมอ (เชื่อมกับโมดูล Reliability เรื่อง redundancy)
