...
- **ESB กลายเป็นคอขวดขององค์กร** — องค์กรใหญ่มักตั้ง ESB เป็น cluster แบบ HA เพื่อไม่ให้เป็นจุดล่มเดี่ยวทางเทคนิค <mark class="hl-warning">แต่ปัญหาจริงคือคอขวดเชิง**องค์กร**: ทุกการเปลี่ยนแปลง routing/transformation logic ต้องผ่านทีมกลางทีมเดียว การเพิ่ม service ใหม่หรือแก้ contract จึงช้าลงเรื่อยๆ เมื่อจำนวนระบบเพิ่มขึ้น</mark> ขัดกับสิ่งที่ microservices ต้องการคือให้แต่ละทีม deploy อิสระได้เอง
