...
นี่คือภาพเดียวกับที่ทีมวิศวกรรมซอฟต์แวร์ทุกทีมต้องตัดสินใจ — จะสร้างระบบแบบ**คลินิกเดี่ยว** (**Monolith**) หรือแบบ**โรงพยาบาลหลายแผนก** (**Microservices**) รายละเอียดว่า "แตกยังไง" แบ่งขอบเขต service ตรงไหน ดูได้ในโมดูล Microservices & API Design ที่เรียนไปแล้ว บทนี้จะโฟกัสคำถามที่มาก่อนหน้านั้น — อะไรคือปัจจัยที่บอกว่า**ถึงเวลาต้องเลือก style ไหน**
...
สิ่งที่มักถูกมองข้ามคือการเลือก style ไม่ใช่การตัดสินใจทางเทคนิคล้วนๆ แต่ผูกกับโครงสร้างองค์กรโดยตรง นักวิจัยชื่อ Melvin Conway เคยตั้งข้อสังเกตไว้ตั้งแต่ปี 1967 ซึ่งภายหลังถูกเรียกว่า **Conway's Law**: ระบบที่องค์กรออกแบบมักมีโครงสร้างสะท้อนโครงสร้างการสื่อสารขององค์กรนั้นเอง ทีมเดียวที่นั่งคุยกันได้ทั่วถึงมักผลิตระบบก้อนเดียว ส่วนหลายทีมที่แยกกันทำงานอิสระมักผลิตระบบที่แยกเป็นหลาย service ตามขอบเขตทีม
...
3. **ความซับซ้อนของ domain** — ถ้ายังไม่รู้ขอบเขตทางธุรกิจที่แท้จริง (bounded context) การแตกเป็น service ก่อนเวลาอันควรมักแตกผิดที่ ต้องมาแก้ทีหลังซึ่งแพงกว่าการรวมไว้ก่อน
