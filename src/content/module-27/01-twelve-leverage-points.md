...
**Leverage Point** คือจุดในระบบที่การเปลี่ยนแปลงเล็กๆ ตรงนั้น ส่งผลใหญ่หลวงต่อพฤติกรรมของทั้งระบบ — Donella Meadows จัดอันดับ leverage point ไว้ 12 ระดับ จากอ่อนที่สุด (ต้องออกแรงเยอะ ได้ผลน้อย) ไปถึงแรงที่สุด (ออกแรงน้อย ได้ผลมาก) เรียงจากล่างขึ้นบน
...
ลูกศรชี้จากอ่อนไปแรง — ยิ่งอยู่ด้านบน (เลขน้อย) ยิ่งเป็นจุดที่แก้แล้วได้ผลมาก แต่ก็มักยากกว่าและมีแรงต้านมากกว่าด้วย (คนไม่ชอบให้แตะ "เป้าหมาย" หรือ "paradigm" ขององค์กรง่ายๆ)
