...
**"ถ้าแก้ parameter ซ้ำแล้วซ้ำเล่า แต่อาการเดิมยังกลับมาเรื่อยๆ ให้สงสัยว่าปัญหาอยู่ที่ structure ไม่ใช่ parameter — ถ้าแก้ structure แล้วก็ยังไม่หาย ให้สงสัยว่าปัญหาอยู่ที่ goals หรือ paradigm"**
...
หลักการนี้สำคัญเพราะมันป้องกันสองความผิดพลาดที่ตรงข้ามกัน — **ผิดพลาดแบบแรก** คือรีบกระโดดไปแก้ paradigm/goals ทุกครั้งทั้งที่จริงๆ แค่ปรับ parameter ก็พอ (สิ้นเปลืองพลังงานการเมืองในองค์กรโดยไม่จำเป็น) **ผิดพลาดแบบสอง** คือติดอยู่ที่การปรับ parameter ซ้ำๆ ไม่รู้จบทั้งที่ปัญหาจริงอยู่ที่ structure หรือ goals (เสียเวลาไปเรื่อยๆ โดยไม่เคยแตะจุดที่แก้ได้จริง) — กฎ "ลองจากอ่อนไปแรง แต่สังเกตว่าเมื่อไหร่ควรขยับ" ช่วยเลี่ยงทั้งสองแบบ
