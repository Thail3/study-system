...
ปัญหาคือสเปกที่เจ้าของร้านให้มาบอกแค่ว่า "แอปต้องทำอะไรได้บ้าง" — เรียกว่า <mark class="hl-term">**Functional Requirement (FR)**</mark> — แต่ไม่เคยบอกเลยว่า "แอปต้องทำสิ่งเหล่านั้นได้ดีแค่ไหน" ภายใต้เงื่อนไขแบบไหน — สิ่งนี้คือ <mark class="hl-term">**Non-Functional Requirement (NFR)**</mark> และเป็นสิ่งที่ทีมพัฒนาไม่ได้ถามหาตั้งแต่ต้น เมื่อไม่มีใครระบุไว้ สถาปัตยกรรมที่สร้างขึ้นมาก็ไม่ได้ถูกออกแบบให้รองรับโหลดสูง ไม่ได้ป้องกันการกดสั่งซ้ำ ทั้งที่ตัวแอปเอง "ทำงานถูกต้อง" ตาม FR ทุกข้อ
...
ปัญหาที่พบบ่อยที่สุดในทีมที่เพิ่งเริ่มเขียน NFR คือเขียนแบบกำกวม เช่น "ระบบต้องเร็ว" "ระบบต้องปลอดภัย" "ระบบต้องรองรับผู้ใช้เยอะๆ" — ประโยคเหล่านี้ฟังดูดีแต่ใช้งานจริงไม่ได้เลย เพราะไม่มีใครรู้ว่า "เร็ว" คือกี่มิลลิวินาที "เยอะๆ" คือกี่คน และที่สำคัญที่สุดคือ<mark class="hl-warning">**ไม่มีทางทดสอบได้ว่าระบบผ่านหรือไม่ผ่าน**</mark> ทีม QA ก็ไม่รู้จะเขียน test อย่างไร ทีม infra ก็ไม่รู้จะซื้อเครื่องขนาดไหน
...
flowchart LR
    ...
    classDef fr fill:#3d6ea552,stroke:#3d6ea5,stroke-width:1.5px
    classDef nfr fill:#6b5b9552,stroke:#6b5b95,stroke-width:1.5px
    class FR,Feature fr
    class NFR,Arch,A1,A2,A3,A4 nfr
```
