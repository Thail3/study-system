...
เกิดขึ้นเมื่อหลายฝ่ายในระบบเดียวกันมี**เป้าหมายที่ขัดแย้งกัน** แต่ละฝ่ายพยายามดึงระบบเข้าหาเป้าหมายของตัวเอง (แต่ละฝ่ายคือ balancing loop ของตัวเอง) ผลคือทุกฝ่ายต้องออกแรงมากขึ้นเรื่อยๆ เพียงเพื่อรักษาสถานะเดิมไว้ ไม่มีใครไปถึงเป้าหมายตัวเองจริงๆ สักที
...
เกิดขึ้นเมื่อทีมตั้งเป้าหมายโดยอิงจาก**ผลงานที่ผ่านมา** (ไม่ใช่มาตรฐานสัมบูรณ์) — ถ้าผลงานแย่ลงนิดหน่อย เป้าหมายรอบถัดไปก็ถูกปรับลงตามไปด้วย "แค่นี้ก็ดีพอแล้วสำหรับตอนนี้" ทำซ้ำไปเรื่อยๆ จนมาตรฐานค่อยๆ ไหลลงต่ำเรื่อยๆ โดยไม่มีจุดไหนที่รู้สึกเหมือนการตัดสินใจ "ยอมรับมาตรฐานต่ำ" อย่างชัดเจนเลยสักครั้ง
...
ตัวอย่างคลาสสิก: วัดผลงาน call center จาก "จำนวนสายที่รับต่อชั่วโมง" พนักงานรีบวางสายเร็วที่สุดเพื่อรับสายต่อไปให้ได้เยอะ ลูกค้าได้รับบริการแย่ลง ทั้งที่พนักงานทุกคนทำตาม metric ที่บริษัทตั้งไว้อย่างสมบูรณ์แบบ — metric "ถูกต้องตามที่วัด" แต่ "ผิดตั้งแต่เลือกจะวัดอะไร"
