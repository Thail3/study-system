...
กุญแจสำคัญคือดูสองแกน — อำนาจต่อรอง (เราคุยกับอีกทีมปรับ API ร่วมกันได้ไหม) และความไว้ใจในคุณภาพโมเดลของอีกฝั่ง (โมเดลของเขาสะอาดพอจะเอามาใช้ตรงๆ ไหม) ถ้าคุยกันได้และไว้ใจได้ก็ใช้ Partnership หรือ Customer-Supplier ถ้าคุยกันได้แต่ไม่มีอำนาจต่อรองก็ต้อง Conformist ถ้าคุยกันไม่ได้เลยหรือโมเดลของอีกฝั่งไม่น่าเชื่อถือ ต้องสร้าง ACL ป้องกันตัวเองไว้ก่อนเสมอ
