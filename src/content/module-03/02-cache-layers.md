...
2. **CDN Cache (ร้านสะดวกซื้อใกล้บ้าน)** — CDN ย่อจาก Content Delivery Network เซิร์ฟเวอร์ edge กระจายอยู่ทั่วโลก ใกล้ user มากกว่า origin server มาก เก็บของที่คนแถวนั้นน่าจะอยากได้ไว้ล่วงหน้า
