...
ระบบซอฟต์แวร์ก็มีปัญหาแบบเดียวกัน — พอย้ายมาใช้ container และ Kubernetes (จากสองบทที่แล้ว) แค่ "รันบน cloud ได้" ยังไม่พอ ต้อง**ออกแบบให้เหมาะกับธรรมชาติของ cloud** ด้วย แนวคิดนี้เรียกว่า <mark class="hl-term">**Cloud-Native**</mark>

## Cloud-Native ไม่ใช่แค่ "รันบน Cloud"

<mark class="hl-warning">หลายคนเข้าใจผิดว่า cloud-native แปลว่าแค่เอาโปรแกรมเดิมไปรันบน AWS/GCP/Azure</mark> ความจริงคือ cloud-native เป็น**ปรัชญาการออกแบบ** — สร้างระบบให้ใช้ประโยชน์จากธรรมชาติของ cloud ได้เต็มที่ ตั้งแต่แรก ไม่ใช่แค่ยกของเก่าไปวางบนเครื่องคนอื่น
