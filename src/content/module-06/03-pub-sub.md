...
Message Queue (บทที่แล้ว) มีสมมติฐานว่า **1 บัตรคิวควรถูกทำโดยบาริสต้าแค่ 1 คน** (พอคนหนึ่งดึงไปทำ คนอื่นดึงซ้ำไม่ได้) แต่บางสถานการณ์ต้องการให้ **ประกาศเดียวกันไปถึงหลายฝ่ายพร้อมกัน** — นี่คือที่มาของ **Pub/Sub**
...
ความต่างสำคัญ: บัตรคิวถูกบาริสต้า**คนใดคนหนึ่ง**หยิบไปแล้วหายจากคิว (คนอื่นไม่เห็นอีก) แต่ประกาศเสียงตามสายถูกส่งไปหา**ทุกห้องที่เปิดลำโพงรับฟัง**พร้อมกัน แต่ละห้องทำงานของตัวเองอย่างอิสระ
