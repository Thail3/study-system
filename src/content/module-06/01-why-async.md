...
ทุก request จนถึงตอนนี้ในหลักสูตรนี้เป็นแบบ **synchronous** — เหมือนนั่งรอหน้าร้านซักรีด: client ส่ง request แล้ว**รอ**จนกว่า server จะประมวลผลเสร็จถึงจะได้ response กลับมา ใช้ได้ดีกับงานเร็ว (สั่งเมนูธรรมดา) แต่ถ้างานหนัก (ส่งอีเมล, ประมวลผลวิดีโอ, สร้างรายงาน) การรอแบบนี้เริ่มมีปัญหา
...
แนวคิดหลัก: **แยกงาน "รับเรื่อง" ออกจากงาน "ทำจริง"** เหมือนร้านซักรีดที่แยกคนรับผ้าหน้าเคาน์เตอร์ ออกจากเครื่องซักที่ทำงานอยู่ข้างหลัง — server ตอบ client ทันทีว่า "รับเรื่องแล้ว" (ให้ job ID เหมือนใบเสร็จ) ส่วนงานหนักจริงไปทำเบื้องหลัง (background) แล้วแจ้งผลทีหลัง (poll สถานะ, webhook, หรือ push notification)
