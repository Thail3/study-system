...
export const modules: ModuleMeta[] = [
  ...
  },
  {
    ...
    title: 'Case Studies',
    titleSub: 'เอา pillar ทั้งหมดมาใช้จริง: e-commerce, security, migration, game platform ฯลฯ',
    status: 'available',
    ...
    topics: [
      ...
      { id: 'legacy-monolith-migration', title: 'Case Study: Migrate Legacy Monolith', file: '04-legacy-monolith-migration' },
      { id: 'game-platform-at-scale', title: 'Case Study: Backend เกมออนไลน์ระดับล้านผู้เล่น', file: '05-game-platform-at-scale' },
      { id: 'secure-payment-platform', title: 'Case Study: Secure Payment Platform จาก Zero', file: '06-secure-payment-platform' },
      { id: 'team-reorg-for-scale', title: 'Case Study: Reorg ทีม Startup ที่กำลังโต', file: '07-team-reorg-for-scale' },
      { id: 'undocumented-legacy-onboarding', title: 'Case Study: Onboard ทีมใหม่เข้าระบบไร้เอกสาร', file: '08-undocumented-legacy-onboarding' },
    ],
  },
  {
    id: 22,
